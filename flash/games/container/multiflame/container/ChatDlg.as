package multiflame.container {
	...
	public class ChatDlg extends MovieClip {
		...
		// If 2 successive messages come from the same person, they will be displayed as
		//
		// Person name: Message1
		// Message2
		//
		// Not
		//
		// Person name: Message1
		// Person name: Message2
		private var _lastChatNick:String;
		...
		private function onClose(event:CloseEvent):void {
			if (event.type == CloseEvent.WILL_CLOSE) {
				addChat(_("The server will close in a few minutes for upgrading, sorry for this inconvenience"));
			}
		}
